...
def classify_metric_messagev2(predict_label_file, labelnumber=3):
    """
    :param predict_label_file:should have type:predict_label,predict_prob,true_label
    :param name:
    :return:
...
if __name__ == '__main__':
    predict_label_file = "classify_metrics_negpos.csv"
    classify_metric_message(predict_label_file, 2)

    predict_label_file = "classify_metrics_threeclass.csv"
    classify_metric_message(predict_label_file, 3)

    predict_label_file = "validationGTvsPd.csv"
    classify_metric_messagev2(predict_label_file, 4)
